# Age-Based Business Advice Program
...
The program will display a message with advice based on the age you entered.
...
The goal was to improve my skills in Python, integer-input, if/elif/else-statement, and logical operator.
